    ...
    <div>
      ...
      <div class="top_bar">
        ...
        <div class="bar_options">
          ...
          <div class="Message">
            <BsIcons.BsEnvelopeFill size={35} />
          </div>
          <div class="Home">
            <AiTwotoneHome
              size={35}
      ...
      <Container>
        <div>
          <select name="job">
            <option id="PeriodSemester" value="2022_1">
              2022-1학기
            </option>
            <option id="PeriodSemester" value="2022_2">
              2022-2학기
            </option>
          </select>
        </div>
        ...
        <div class="Input_period">
          <form id="SubmitPeriodBasket">
            ...
            <div class="Period_start">
              <input type="datetime-local" id="PeriodBasketStartDate" />
            </div>
            <div class="Period_blank">
              <text>~</text>
            </div>
            <div class="Period_end">
              <input type="datetime-local" id="PeriodBasketEndDate" />
            </div>
            <div class="Period_submit">
              <input
                type="button"
                onClick={(e) => AxiosPeriodBasket()}
                value="확인"
              />
            </div>
          </form>
        ...
        <div class="Input_period">
          <form>
            ...
            <div class="Period_start">
              <input type="datetime-local" id="PeriodRegisterStartDate" />
            </div>
            <div class="Period_blank">
              <text>~</text>
            </div>
            <div class="Period_end">
              <input type="datetime-local" id="PeriodRegisterEndDate" />
            </div>
            <div class="Period_submit">
              <input
                type="button"
                onClick={(e) => AxiosPeriodRegister()}
                value="확인"
              />
            </div>
          </form>
        ...
        <div class="Input_period">
          <form>
            ...
            <div class="Period_start">
              <input type="datetime-local" id="PeriodModifyStartDate" />
            </div>
            <div class="Period_blank">
              <text>~</text>
            </div>
            <div class="Period_end">
              <input type="datetime-local" id="PeriodModifyEndDate" />
            </div>
            <div class="Period_submit">
              <input
                type="button"
                onClick={(e) => AxiosPeriodModify()}
                value="확인"
              />
            </div>
          </form>
        ...
        <div class="Input_period">
          <form>
            ...
            <div class="Period_start">
              <input type="datetime-local" id="PeriodCancleStartDate" />
            </div>
            <div class="Period_blank">
              <text>~</text>
            </div>
            <div class="Period_end">
              <input type="datetime-local" id="PeriodCancleEndDate" />
            </div>
            <div class="Period_submit">
              <input
                type="button"
                onClick={(e) => AxiosPeriodCancle()}
                value="확인"
              />
            </div>
          </form>
